const faq =
{
    ...
    `I will deliver anywhere in the world where there are amazon lockers. If there are any problems with your order related to international issues, I will issue you a full refund.`
        ...
        `My service is 2% on top of the amazon order subtotal. 
        For example, if you were to buy a 100-dollar hardware wallet from amazon
        my service would cost you 101 dollars. At checkout, with me, you would pay 102 USD worth of Monero. My service assumes that the sales tax
